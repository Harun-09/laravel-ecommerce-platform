...
import homeliving from './data/homeliving.json';
import sports from './data/sports.json';
import groceries from './data/groceries.json';

const allProducts = [...beauty, ...books, ...electronics, ...fashion, ...homeliving, ...sports, ...groceries];
    ...
    <div className="container section">
        <div className="ex-style-72">
            ...
            <div className="ex-style-84">
                <div className="ex-style-85"><div><h1 className="ex-style-86">All Products</h1><p className="ex-style-87">Showing {allProducts.length} products</p></div><div className="ex-style-88"><span className="ex-style-89">Sort by:</span><select className="ex-style-90"><option>Newest</option><option>Price: Low to High</option><option>Price: High to Low</option><option>Most Popular</option><option>Best Rating</option></select></div></div>
